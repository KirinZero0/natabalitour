      ...
      <tr>
        ...
        <td class="container">
          <div class="content">
            ...
            <span class="preheader">We got a new Activity</span>
            <table
              role="presentation"
              border="0"
              cellpadding="0"
            ...
            >
              ...
              <tr>
                <td class="wrapper">
                  <p>Hi there</p>
                  <p>
                    We are delighted to inform you that a new activity booking
                    has been confirmed for Mr/Mrs. <strong>Jake</strong>. He has
                    reserved the <strong>Surfing Package</strong> scheduled for
                    <strong>January 28, 2023</strong>. Please take a moment to
