...
<head>
  ...
  <title>Nata Bali Tours - Activity Details</title>
  ...
  <style>
    #hero {
        width: 100%;
        height: 100vh;
        background: url("{{$activity->getImageUrl()}}") top right;
...
<body>
    ...
    <section class="about">
        <div class="container">
          <div class="section-title">
            <span>About {{$activity->activity_name}}</span>
            <h2>About {{$activity->activity_name}}</h2>
    ...
    <section class="contact">
        <div class="container">
            ...
            <div>
              ...
              <div>
                <form action="{{ route('activities.book') }}" enctype="multipart/form-data" method="post" class="needs-validation form-frame" novalidate>
                    @csrf
                    <div class="row">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6 form-group mt-3 mt-md-0">
                            ...
                            <input type="text" name="activity" class="form-control" value="{{ $activity->activity_name }} - Rp{{ $activity->price }}" readonly required>
                        </div>
                    </div>
  ...
  <script>
    ...
    var priceInput = document.querySelector('input[name="activity"]');
    ...
    numberOfPeopleInput.addEventListener('input', function() {
        ...
        var newPrice = numberOfPeople * {{ $activity->price }};
        
        // Update the price input value
        priceInput.value = "{{ $activity->activity_name }} - Rp" + newPrice;
    });
</script>
<script>
