  ...
  <section id="hero">
    ...
    <section class="contact">
        <div class="container">
            ...
            <div>
                <form action="{{ route('activities.book') }}" enctype="multipart/form-data" method="post"
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-6 form-group mt-3 mt-md-0">
                        ...
                        <input type="text" name="activity" class="form-control" value="{{ $activity->activity_name }} - Rp{{ $activity->price }}" readonly>
                    </div>
                </div>
