...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section">
        <form action="{{ route('admin.package.update', $package->id) }}" enctype="multipart/form-data" method="post"
        ...
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                <h5 class="card-title">Package Profile</h5>
                    <div class="row mb-3">
                        <label for="inputText" class="col-sm-2 col-form-label">Package Code</label>
                        <div class="col-sm-10">
                        <input name="package_code" type="text" class="form-control" value="{{$package->package_code}}">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputEmail" class="col-sm-2 col-form-label">Package Name</label>
                        <div class="col-sm-10">
                        <input name="package_name" type="text" class="form-control" value="{{$package->package_name}}">
                        </div>
                    </div>
                </div>
            </div>
