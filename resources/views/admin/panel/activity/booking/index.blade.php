        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h5 class="card-title">Activity Bookings</h5>
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <a href="{{ route('admin.booking.activity.create') }}" class="btn btn-secondary" title="Add"><i class="bi bi-plus"></i> Add</a>
                    </div>
                        ...
                        @forelse($bookings as $booking)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a class="btn btn-secondary btn-sm" href="{{ route('admin.booking.activity.edit', ['booking' => $booking]) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="bi bi-pen-fill"></i></a>
                                    <a class="btn btn-success btn-sm" href="{{ route('admin.booking.activity.approve', ['booking' => $booking]) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Approve"><i class="bi bi-check-circle"></i></a>
                                    <a class="btn btn-danger btn-sm" href="{{ route('admin.booking.activity.reject', ['booking' => $booking]) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Reject"><i class="bi bi-exclamation-octagon"></i></a>
                                    <a class="btn btn-warning btn-sm" href="{{ route('admin.booking.activity.cancel', ['booking' => $booking]) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Cancel"><i class="bi bi-exclamation-triangle"></i></a>
                                    ...
                                    @elseif($booking->status == \App\Enums\BookingStatusEnum::CANCELED || $booking->status == \App\Enums\BookingStatusEnum::REJECTED || $booking->status == \App\Enums\BookingStatusEnum::APPROVED)
                                        ...
                                        $url = urlencode("We are pleased to confirm your booking, Mr./Mrs. {$booking->name}, for the {$booking->activity->activity_name} scheduled on {$booking->date->format('d F Y')}. Your reservation has been received by Nata Bali Tours, ensuring you an unforgettable experience tailored to your preferences. We will pick you up at {$booking->address}. Thank you for choosing Nata Bali Tours.");
                                        @endphp
                                        <a class="btn btn-danger btn-sm" href="{{ route('admin.booking.activity.delete', ['booking' => $booking->id]) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="delete"><i class="bi bi-trash-fill"></i></a>
                                        <button type="button" class="btn btn-dark btn-sm" data-bs-toggle="modal" data-bs-placement="top" title="Details" data-bs-target="#verticalycentered{{ $booking->id }}"><i class="bi bi-folder"></i> Details</button>
                                        <a class="btn btn-success btn-sm" href="https://wa.me/{{$phoneNumber}}?text={{$url}}" data-bs-toggle="tooltip" data-bs-placement="top" title="Whatsapp"><i class="bi bi-whatsapp"></i></a>
                                    @endif
                                </td>
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <p><strong>Activity:</strong>{{ $booking->activity->activity_name }}</p>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        {{-- <img src="{{$booking->getImageUrl()}}" alt=""> --}}
                                                        
                                                        <a class="btn btn-secondary"  href="{{ route('admin.booking.activity.image', ['booking' => $booking]) }}" target="_blank">Payment</a>
                                                    </div>
                                                </div>
                                            </div>
